...
@section('title') Data Instansi Kerja @endsection
@section('content')
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-12">
                <h4 class="page-title">Data Instansi Kerja</h4>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Data Instansi Kerja</li>
                </ol>
            </div>
        </div>
        <!-- End Breadcrumb-->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-table"></i> Data Instansi Kerja
                        <div class="btn-group float-sm-right">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{route('instansiCetak')}}" target="_blank" class="dropdown-item">Keseluruhan</a>
                        ...
                        <div class="table-responsive">
                            <table id="default-datatable" class="table table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode Instansi Kerja</th>
                                        <th>Nama Instansi Kerja</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<script>
    $(document).on('click', '.delete', function(e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{url('/admin/instansi/delete')}}" + '/' + id,
                    type: "POST",
                    data: {
                        '_method': 'DELETE',
                        "_token": "{{ csrf_token() }}"
