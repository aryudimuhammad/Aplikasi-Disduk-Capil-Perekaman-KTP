                            ...
                            <div class="col-lg-4">
                                <div class="card profile-card-2">
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <p class="card-text">Status : @if($data->status_ktp == 1) <a class="text-warning">Belum Diverifikasi</a> @elseif($data->status_ktp == 2) <a class="text-primary">Tererifikasi</a> @elseif($data->status_ktp == 3) <a class="text-danger">Tidak Diverifikasi</a> @elseif($data->status_ktp == 4) <a class="text-info">Belum Diambil</a> @else <a class="text-success">Sudah Diambil</a> @endif </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
