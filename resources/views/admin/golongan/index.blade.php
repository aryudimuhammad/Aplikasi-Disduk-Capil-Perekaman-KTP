...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            <div class="col-sm-12">
                <h4 class="page-title">Data Golongan</h4>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-table"></i> Data Golongan
                        <div class="btn-group float-sm-right">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{route('golonganCetak')}}" target="_blank" class="dropdown-item">Keseluruhan</a>
                                <button data-toggle="modal" data-target="#modalcetaknama" class="dropdown-item">Cetak Pegawai Berdasarkan Nama Golongan</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
@include('admin.golongan.cetaknama')
