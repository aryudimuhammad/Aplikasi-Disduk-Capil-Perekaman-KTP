...
@section('title') Data Unit Kerja @endsection
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-table"></i> Data Unit Kerja
                        <div class="btn-group float-sm-right">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <button data-toggle="modal" data-target="#modalcetaknama" class="dropdown-item">Cetak Pegawai Berdasarkan Nama Unit Kerja</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
