                    ...
                    <div class="card-header">
                        ...
                        <div class="btn-group float-sm-right">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{route('pensiunCetak')}}" target="_blank" class="dropdown-item">Keseluruhan</a>
                                <button data-toggle="modal" data-target="#modalcetaktgl" class="dropdown-item">Cetak Berdasarkan Tanggal Pengusulan Pensiun</button>
                            </div>
                            @endif
                        </div>
                    </div>
...
@include('admin.pensiun.cetaktgl')
